...
export default function SolutionsPage() {
  return (
    <div className="page-shell">
      ...
      <section className="page-section"><div className="container visual-feature"><div><SectionHeader eyebrow="Hybrid power" title="Solar + battery + generator, planned as one system" text="A hybrid system must connect generation, storage, backup power, critical loads, and site conditions. The image is representative; final sizing is subject to assessment." /><Link className="btn btn-primary" to="/request-quote?product=hybrid-system">Plan a hybrid system</Link></div><img src={siteImages.hybrid.imagePath} alt={siteImages.hybrid.altText} loading="lazy" width="1200" height="800" /></div></section>
